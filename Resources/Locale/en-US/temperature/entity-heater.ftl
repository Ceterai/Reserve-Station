...
entity-heater-switch-setting = Switch to { -entity-heater-setting-name($setting) }
entity-heater-switched-setting = Switched to { -entity-heater-setting-name($setting) }.
