...
entity-heater-switch-setting = Переключить на { -entity-heater-setting-name($setting) }
entity-heater-switched-setting = Переключён на { -entity-heater-setting-name($setting) }.
