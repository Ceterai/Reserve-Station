...
cosmiccult-vote-steward-briefing =
    ...
    Проследите, чтобы Монумент был установлен в надёжном месте, и организуйте культ так, чтобы обеспечить вашу коллективную победу.
...
cosmiccult-vote-lone-steward-briefing =
    ...
    Проследите, чтобы монумент был установлен в надёжном месте, и завершите то, что начал культ.
