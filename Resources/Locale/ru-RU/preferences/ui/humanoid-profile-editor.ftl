...
humanoid-profile-editor-appearance-tab = Основное
...
humanoid-profile-editor-export-image-button = Экспорт спрайта
humanoid-profile-editor-open-image-button = Открыть спрайты
...
humanoid-profile-editor-job-priority-never-button = Нет
...
humanoid-profile-editor-markings-tab = Внешность
