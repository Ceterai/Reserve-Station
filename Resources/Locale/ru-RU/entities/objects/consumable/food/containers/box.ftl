...
ent-FoodMealHappyHonkBigBite = обед Хэппи Хонк Биг Байт
    .suffix = Игрушка Безопасный
    .desc = Кто-то заплатил хорошие деньги, чтобы эта фастфуд-еда была доставлена таким образом. Она пахнет свежей, каким-то образом.
