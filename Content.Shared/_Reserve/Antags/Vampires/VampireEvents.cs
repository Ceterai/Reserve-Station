...
namespace Content.Shared._Reserve.Antags.Vampires;
...
public sealed partial class VampireSanguinePoolActionEvent : InstantActionEvent
{
    ...
    [DataField]
    public SoundSpecifier EnterSound = new SoundPathSpecifier("/Audio/_Reserve/Effects/vampire/enter_blood.ogg");

    [DataField]
    public SoundSpecifier ExitSound = new SoundPathSpecifier("/Audio/_Reserve/Effects/vampire/exit_blood.ogg");
...
{
    [DataField]
    public SoundSpecifier Sound = new SoundPathSpecifier("/Audio/_Reserve/Effects/vampire/blooderruption.ogg");
...
public sealed partial class VampireMassHysteriaActionEvent : InstantActionEvent
{
    ...
    [DataField]
    public SoundSpecifier Sound = new SoundPathSpecifier("/Audio/_Reserve/Effects/vampire/sound_hallucinations_im_here1.ogg");
}
...
public sealed partial class VampireDemonicGraspActionEvent : WorldTargetActionEvent
{
    ...
    [DataField]
    public SoundSpecifier Sound = new SoundPathSpecifier("/Audio/_Reserve/Effects/vampire/exit_blood.ogg");
}
