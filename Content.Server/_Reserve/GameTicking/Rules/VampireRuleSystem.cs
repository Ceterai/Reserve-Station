...
using Content.Server._Reserve.GameTicking.Rules.Components;
...
namespace Content.Server._Reserve.GameTicking.Rules;
...
public sealed partial class VampireRuleSystem : GameRuleSystem<VampireRuleComponent>
{
    ...
    public readonly SoundSpecifier BriefingSound = new SoundPathSpecifier("/Audio/_Reserve/Ambience/Antag/vampire_start.ogg");
    ...
    public bool MakeVampire(EntityUid target, VampireRuleComponent rule)
    {
        ...
        // Reserve edit: Vampires - Goob does not expose RoleBriefingComponent in this fork.
