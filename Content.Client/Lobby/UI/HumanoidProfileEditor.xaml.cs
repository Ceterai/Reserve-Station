...
// using Content.Goobstation.Common.CCVar; // Goob Station - Barks // Reserve - use the other barks
// using Content.Goobstation.Common.Barks; // Goob Station - Barks // Reserve - use the other barks
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            MarkingManager markings)
        {
            ...
            */
            ...
            _rgbSkinColorSelector.SelectorType = ColorSelectorSliders.ColorSelectorType.Rgb; // defaults color selector to RGB // Reserve edit: HSV -> RGB
            ...
            InitializeBark(); // Reserve - use the other barks
            ...
            foreach (var group in antagGroups)
            {
                ...
                foreach (var antag in categoryAntags)
                {
                    ...
                    if (iconTexture == null)
                    {
                        ...
                        {
                            _sawmill.Error($"Antag '{antag.ID}' fallback icon failed to load.");
                        }
                        _sawmill.Error($"Antag '{antag.ID}' is missing its prototype icon.");
                    }
                    if (iconTexture != null)
        ...
        public void SetProfile(HumanoidCharacterProfile? profile, int? slot)
        {
            ...
            UpdateSaveButton();
            UpdateMarkings();
            // UpdateBarkVoice(); // Goob Station - Barks // Reserve - use the other barks
            UpdateHairPickers();
            UpdateCMarkingsHair();
            UpdateCMarkingsFacialHair();
            UpdateHeightWidthSliders(); // Goobstation: port EE height/width sliders
        ...
        public void RefreshJobs()
        {
            ...
            foreach (var department in departments)
            {
                ...
                var altJobTitlesEnable = _cfgManager.GetCVar(CCVars.ICAlternateJobTitlesEnable);  // Reserve: Alternate Job Titles
                ...
                foreach (var job in jobs)
                {
                    ...
                    if (altJobTitlesEnable)  // Reserve: Alternate Job Titles
                    {
                        ...
                        if (job.AlternateTitles != null)
                        {
                            ...
                            foreach (var titleId in job.AlternateTitles)
                            {
                                ...
                                {
                                    if (!_requirements.IsAllowed(job, Profile, out _))
                                    {
                                        isLocked = true;
                                    }
                                }
